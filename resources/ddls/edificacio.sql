...
"TIPUS_EDIFICACIO" varchar2(32) not null,
"US_EDIFICACIO" varchar2(25),
...
CREATE INDEX "X__EDIFICACIO_PU_1" ON "EDIFICACIO" ("PUNT_BASE")
	...
	PARAMETERS('LAYER_GTYPE="MULTIPOINT", TABLESPACE="GIS"');
...
CREATE INDEX "X__EDIFICACIO_PE_3" ON "EDIFICACIO" ("PERIMETRE_BASE")
	INDEXTYPE IS MDSYS.SPATIAL_INDEX
	PARAMETERS('LAYER_GTYPE="MULTIPOLYGON", TABLESPACE="GIS"');
